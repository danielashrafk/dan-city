...
public abstract class Unit implements Simulatable, SOSResponder {
	...
	public void respond(Rescuable r) throws UnitException {
	     if(!(this.Compatible(r)))
			...
			throw new CannotTreatException(this, r, "No need to treat the target.");
		}
	...
	public boolean Compatible(Rescuable r) {
		...
		if((this instanceof Evacuator || this instanceof FireTruck || this instanceof GasControlUnit) && r instanceof Citizen) {
			return false;
		}
		
		else if((this instanceof Ambulance || this instanceof DiseaseControlUnit) && r instanceof ResidentialBuilding) {
			return false;
		}
